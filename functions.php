...
function learningWordPress_customize_register( $wp_customize ){
	...
	$wp_customize->add_control(
		...
		$wp_customize, 'lwp_link_color_control', array(
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
		$wp_customize, 'lwp_button_color_control', array(
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
		$wp_customize, 'lwp_btn_hover_color_control', array(
		        'label' => __('button Color hover', 'LearningWordPress'),
		        'section' => 'lwp_standard_colors',
